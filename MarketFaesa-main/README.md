...
### Pelo IntelliJ IDEA
1. Abra a pasta `Market Faesa Main` como projeto Maven.
2. Execute `ServicoApp.java`. Não é preciso configurar `--module-path` manualmente — o `module-info.java` e as dependências do Maven cuidam disso.
